...
import { builtInComponents, ComponentRegistry, defaultRegistry } from '../registry';
...
describe('ComponentRegistry', () => {
  ...
  describe('getByCategory()', () => {
    it('should return components by category', () => {
      registry.registerMany(builtInComponents);
  ...
  describe('getGroupedByCategory()', () => {
    ...
    it('should have correct counts', () => {
      ...
      expect(totalCount).toBe(builtInComponents.length);
    });
  });
  ...
  describe('getAll()', () => {
    it('should return all registered components', () => {
      ...
      expect(all.length).toBe(builtInComponents.length);
    });
