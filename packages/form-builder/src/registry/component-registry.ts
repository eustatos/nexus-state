...
import type { FieldSchema, FieldCategory } from '../schema/types';
...
export interface ComponentDefinition {
  ...
  renderPreview: (props: Partial<FieldSchema>) => string | JSX.Element;
  /** Render actual field (interactive) */
  renderField: (props: FieldSchema) => string | JSX.Element;
