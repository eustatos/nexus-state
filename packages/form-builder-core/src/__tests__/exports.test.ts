...
describe('Package Exports', () => {
  ...
  describe('Registry exports', () => {
    it('should export built-in components', () => {
      expect(formBuilder.mockComponents).toBeDefined();
      expect(Array.isArray(formBuilder.mockComponents)).toBe(true);
      expect(formBuilder.mockComponents.length).toBeGreaterThan(0);
    });
